...
const DATA = {
  ...
  experience: [
    ...
    },
    {
      ...
      type: "Academic",
      bullets: [
        "Delivered and helped design technical training curricula to over 100 participants.",
...
const Section = ({ id, title, icon: Icon, children }) => (
  <section
    id={id}
    className="py-12 md:py-16 relative border-b border-slate-200/50 dark:border-slate-800/50 last:border-0 transition-colors duration-300"
  >
    <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
      <FadeIn>
        <div className="flex items-center space-x-3 mb-8 md:mb-10">
          <div className="p-2.5 bg-cyan-100 dark:bg-cyan-500/10 rounded-xl text-cyan-600 dark:text-cyan-400 border border-cyan-200 dark:border-cyan-500/20 shadow-[0_0_15px_rgba(34,211,238,0.15)] transition-colors duration-300 shrink-0">
            <Icon size={22} strokeWidth={2.5} />
          </div>
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 dark:text-white transition-colors duration-300 tracking-tight">
            {title}
          </h2>
        </div>
      </FadeIn>
...
const TerminalGraphic = () => (
  <div className="relative w-full aspect-[4/5] sm:aspect-[5/4] max-w-[360px] mx-auto rounded-xl border border-slate-300/50 dark:border-slate-700/50 shadow-2xl overflow-hidden flex flex-col group bg-white/80 dark:bg-[#0f172a]/90 backdrop-blur-xl transition-all duration-500 hover:shadow-[0_0_30px_rgba(34,211,238,0.15)] hover:border-cyan-500/30">
    ...
    {/* Terminal Header */}
    <div className="h-8 w-full bg-slate-100 dark:bg-[#1e293b] flex items-center px-3 border-b border-slate-200 dark:border-slate-700/50 transition-colors shrink-0">
      ...
      <div className="relative z-10 space-y-3 sm:space-y-4 font-mono text-xs sm:text-sm">
        ...
        <div className="transform group-hover:translate-x-1 transition-transform duration-300 delay-75">
          ...
          <div className="text-blue-600 dark:text-blue-400 ml-2 sm:ml-3 mt-1.5 leading-relaxed">
            <div className="flex items-center"><ChevronRight size={12} className="mr-1 shrink-0" /> Cybersecurity</div>
            <div className="flex items-center"><ChevronRight size={12} className="mr-1 shrink-0" /> Penetration Testing</div>
            <div className="flex items-center"><ChevronRight size={12} className="mr-1 shrink-0" /> Cloud Security</div>
          </div>
        </div>
...
export default function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setReadingProgress(totalScrollable > 0 ? (window.scrollY / totalScrollable) * 100 : 0);
  ...
  const NAV_PRIMARY = ['Home', 'Education', 'Experience', 'Publications', 'Skills'];
  const NAV_MORE = ['Projects', 'Certifications', 'Awards', 'Extracurricular'];

  return (
    <div
      className="min-h-screen bg-slate-50 dark:bg-[#030712] font-sans text-slate-700 dark:text-slate-300 selection:bg-cyan-200 dark:selection:bg-cyan-900/50 selection:text-cyan-900 dark:selection:text-cyan-100 transition-colors duration-300 overflow-x-hidden relative"
      style={{ fontFamily: "'Inter', system-ui, sans-serif" }}
    >

      {/* Reading Progress Bar */}
      <div
        className="fixed top-0 left-0 z-[200] h-[3px] bg-gradient-to-r from-cyan-500 to-blue-500 transition-[width] duration-150 ease-out pointer-events-none"
      ...
      <button
        ...
        className={`fixed bottom-6 right-5 sm:right-8 z-50 p-3 bg-cyan-500 hover:bg-cyan-400 active:bg-cyan-600 text-slate-900 rounded-full shadow-lg shadow-cyan-500/30 transition-all duration-300 hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:ring-offset-2 ${
      ...
      <nav
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
          scrolled
            ? 'bg-white/80 dark:bg-[#030712]/80 backdrop-blur-lg border-b border-slate-200 dark:border-slate-800 shadow-sm'
            : 'bg-transparent'
        }`}
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 md:h-20 flex items-center justify-between">
          ...
          <button
            ...
            className="font-extrabold text-xl md:text-2xl text-slate-900 dark:text-white tracking-tighter flex items-center gap-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 rounded-lg"
            aria-label="Go to top"
          >
            <Shield className="text-cyan-600 dark:text-cyan-400" size={22} aria-hidden="true" />
          ...
          <div className="hidden lg:flex items-center space-x-1 xl:space-x-2 bg-slate-100/50 dark:bg-slate-800/30 p-1 rounded-full border border-slate-200/50 dark:border-slate-700/50 backdrop-blur-md">
            {NAV_PRIMARY.map((item) => (
              <button
                ...
                className={`px-4 py-1.5 text-xs md:text-sm font-semibold rounded-full transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 ${
            ...
            <div className="relative group px-1">
              <button className="flex items-center space-x-1 px-3 py-1.5 text-xs md:text-sm font-semibold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white rounded-full hover:bg-slate-200/50 dark:hover:bg-slate-700/50 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400">
                <span>More</span>
          ...
          <div className="flex items-center space-x-2 md:space-x-3">
            ...
            <button
              ...
              className="p-2 text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-full transition-all duration-300 border border-slate-200 dark:border-slate-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400"
            ...
            <button
              ...
              className="lg:hidden p-2 text-slate-600 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 rounded-full transition-colors border border-slate-200 dark:border-slate-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400"
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="lg:hidden absolute top-full left-0 w-full bg-white/95 dark:bg-[#030712]/95 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 shadow-2xl px-4 sm:px-6 py-4 flex flex-col space-y-1.5 max-h-[80vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4 pt-4 border-t border-slate-200 dark:border-slate-800">
              <a
                href={`mailto:${DATA.personal.email}`}
                className="flex items-center justify-center px-4 py-2.5 bg-slate-900 dark:bg-cyan-500 text-white dark:text-slate-900 text-sm font-bold rounded-xl transition-all shadow-md hover:opacity-90"
              >
                <Mail size={14} className="mr-2" aria-hidden="true" /> Email
              </a>
              <a
              ...
              >
                <Linkedin size={14} className="mr-2" aria-hidden="true" /> LinkedIn
              </a>
              <a
              ...
              >
                <GraduationCap size={14} className="mr-2" aria-hidden="true" /> Scholar
              </a>
            </div>
          </div>
        )}
      ...
      {/* ── Hero ── */}
      <section id="home" className="pt-28 pb-10 md:pt-36 md:pb-14 px-4 sm:px-6 max-w-6xl mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-8 items-center justify-between">

          <div className="flex-1 space-y-5 text-center lg:text-left min-w-0">

            {/* Status badge */}
            <FadeIn>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20 rounded-full text-emerald-700 dark:text-emerald-400 text-sm font-semibold">
                <span className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse shrink-0" aria-hidden="true"></span>
            ...
            <FadeIn delay={180}>
              <p className="text-xl md:text-2xl text-slate-600 dark:text-slate-300 font-bold">
            ...
            <FadeIn delay={300}>
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 pt-1">
                <a
                  href={`mailto:${DATA.personal.email}`}
                  className="flex items-center space-x-2 px-5 py-2.5 bg-slate-900 hover:bg-slate-800 dark:bg-white dark:hover:bg-slate-100 text-white dark:text-slate-900 rounded-full text-sm font-bold transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-2 px-5 py-2.5 bg-white dark:bg-slate-800/50 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-white border border-slate-200 dark:border-slate-700 rounded-full text-sm font-bold transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5 backdrop-blur-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400"
                >
                  <Linkedin size={16} className="text-[#0a66c2] dark:text-[#70b5f9]" aria-hidden="true" />
                  <span>LinkedIn</span>
                </a>
                <a
                  href={DATA.personal.scholar}
                  ...
                  className="flex items-center space-x-2 px-5 py-2.5 bg-white dark:bg-slate-800/50 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-white border border-slate-200 dark:border-slate-700 rounded-full text-sm font-bold transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5 backdrop-blur-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400"
                >
                  <GraduationCap size={16} className="text-slate-700 dark:text-slate-300" aria-hidden="true" />
                  <span>Google Scholar</span>
                </a>
                <div className="flex items-center space-x-1.5 text-slate-500 dark:text-slate-400 px-2 py-2 text-sm font-medium">
            ...
            {/* Stats Row */}
            <FadeIn delay={420}>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-5 border-t border-slate-200/80 dark:border-slate-800/80">
          ...
          {/* Terminal Graphic */}
          <FadeIn delay={200} className="w-full max-w-[340px] lg:w-[40%] lg:flex-shrink-0 relative mt-4 lg:mt-0">
            <div className="absolute -inset-3 bg-gradient-to-tr from-cyan-500/20 to-blue-500/20 blur-2xl rounded-[3rem] -z-10" aria-hidden="true"></div>
            <TerminalGraphic />
          </FadeIn>
          ...
          {DATA.education.map((edu, idx) => (
            <FadeIn key={idx} delay={idx * 100}>
              <div className="bg-gradient-to-br from-slate-900 to-slate-800 dark:from-[#0f172a] dark:to-[#020617] text-white p-6 sm:p-8 rounded-2xl shadow-xl relative overflow-hidden border border-slate-700 dark:border-slate-800 group hover:border-cyan-500/50 transition-all duration-500 hover:shadow-[0_0_30px_rgba(34,211,238,0.1)]">
                <div className="absolute -right-20 -top-20 w-56 h-56 bg-cyan-500/20 rounded-full blur-[60px] group-hover:bg-cyan-500/30 transition-colors duration-500 pointer-events-none" aria-hidden="true"></div>
                <div className="absolute right-0 bottom-0 opacity-5 transform translate-x-1/4 translate-y-1/4 group-hover:scale-110 transition-transform duration-700 pointer-events-none" aria-hidden="true">
                  <GraduationCap size={200} />
                </div>
                <div className="relative z-10">
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-5 gap-3">
                    <h3 className="text-xl sm:text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-300">
                      {edu.degree}
                    </h3>
                  ...
                  <div className="flex flex-wrap gap-3 mt-6">
                    <div className="bg-slate-950/40 backdrop-blur-md px-4 py-2.5 rounded-xl border border-slate-700/50">
                      ...
                      <span className="font-extrabold text-lg text-blue-400 block">
                        {edu.details.replace('Major Concentration: ', '')}
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <div className="relative pl-3 sm:pl-0 before:hidden sm:before:block before:absolute before:inset-0 before:ml-4 before:-translate-x-px before:h-full before:w-[2px] before:bg-gradient-to-b before:from-cyan-500/50 before:via-blue-500/50 before:to-transparent">
          <div className="space-y-7 md:space-y-10">
            {DATA.experience.map((exp, idx) => (
              <FadeIn key={idx} delay={Math.min(idx * 70, 350)}>
                <div className="relative flex flex-col sm:flex-row items-start group">
                  {/* Timeline Dot */}
                  <div
                    className="hidden sm:flex absolute left-0 mt-1.5 items-center justify-center w-8 h-8 rounded-full border-[3px] border-slate-50 dark:border-[#030712] bg-cyan-500 dark:bg-cyan-400 text-white dark:text-slate-900 shadow-[0_0_10px_rgba(34,211,238,0.5)] z-10 transition-transform duration-300 group-hover:scale-110 shrink-0"
                    aria-hidden="true"
                  >
                  ...
                  <div className="sm:ml-12 w-full bg-white/60 dark:bg-slate-900/40 backdrop-blur-md p-5 sm:p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-lg hover:shadow-cyan-500/5 dark:hover:shadow-cyan-500/10 transition-all duration-300 group-hover:border-cyan-300/50 dark:group-hover:border-cyan-700/50 group-hover:-translate-y-1 relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-full h-[3px] bg-gradient-to-r from-transparent via-cyan-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" aria-hidden="true"></div>
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-3 gap-2">
                      <div className="min-w-0">
                        ...
                        <p className="text-sm sm:text-base font-semibold text-cyan-600 dark:text-cyan-400 mt-0.5">{exp.company}</p>
                      </div>
                      <div className="flex flex-row lg:flex-col items-center lg:items-end gap-2 shrink-0">
                        <span className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider bg-slate-100 dark:bg-slate-800/80 px-2.5 py-1 rounded-full whitespace-nowrap">
                          {exp.period}
                        </span>
                    ...
                    <ul className="space-y-2 mt-4">
                      {exp.bullets.map((bullet, bIdx) => (
                        <li key={bIdx} className="flex items-start text-left text-sm text-slate-600 dark:text-slate-300">
                          <ChevronRight size={16} className="shrink-0 text-cyan-500 mt-[3px] mr-2.5" aria-hidden="true" />
      ...
      <Section id="publications" title="Research & Publications" icon={BookOpen}>
        <div className="grid gap-5">
          {DATA.publications.map((pub, idx) => (
            <FadeIn key={idx} delay={idx * 100}>
              <div className="bg-white/60 dark:bg-slate-900/40 backdrop-blur-md p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-lg transition-all duration-300 group relative overflow-hidden">
                <div className="hidden md:block absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-cyan-400 to-blue-600 transform origin-bottom scale-y-0 group-hover:scale-y-100 transition-transform duration-500 ease-out" aria-hidden="true"></div>
                <div className="flex flex-col lg:flex-row lg:items-start justify-between mb-3 gap-3 lg:gap-4">
                  <div className="lg:w-3/4 min-w-0">
                    <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white mb-1 group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors duration-300 leading-snug">
                      {pub.title}
                    </h3>
                    <p className="text-xs sm:text-sm font-semibold text-slate-500 dark:text-slate-400">{pub.publisher}</p>
                  </div>
                  <div className="flex flex-row lg:flex-col items-center lg:items-end gap-2 shrink-0">
                    <span className="inline-flex px-2.5 py-1 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 uppercase tracking-wider rounded-full text-[11px] font-bold shadow-sm border border-slate-200 dark:border-slate-700/50 whitespace-nowrap">
                      {pub.date}
                    </span>
                    <span className="flex items-center gap-1.5 text-cyan-700 dark:text-cyan-400 bg-cyan-50 dark:bg-cyan-500/10 px-2.5 py-1 rounded-lg text-[11px] font-bold border border-cyan-100 dark:border-cyan-500/20 whitespace-nowrap">
                      <FileText size={12} aria-hidden="true" />
                      {pub.type}
                    </span>
                  </div>
                </div>
                <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">{pub.description}</p>
              </div>
            </FadeIn>
          ))}
        </div>
      ...
      <Section id="skills" title="Technical Skills" icon={Code}>
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-5">
          {DATA.skills.map((skillGroup, idx) => (
            <FadeIn key={idx} delay={idx * 100}>
              <div className="bg-white/60 dark:bg-slate-900/40 backdrop-blur-md p-5 lg:p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-lg transition-all duration-300 hover:border-cyan-200 dark:hover:border-cyan-800/50 group h-full">
                <h3 className="text-sm sm:text-base font-bold text-slate-900 dark:text-white mb-4 flex items-center">
                  <span className="w-6 h-[3px] bg-cyan-500 rounded-full mr-2.5 group-hover:w-10 transition-all duration-300 shrink-0" aria-hidden="true"></span>
                  {skillGroup.category}
                </h3>
      ...
      <Section id="projects" title="Projects & Architecture" icon={FolderGit2}>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {DATA.projects.map((project, idx) => (
            <FadeIn key={idx} delay={idx * 100}>
              <div className="bg-white/60 dark:bg-slate-900/40 backdrop-blur-md p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-lg hover:-translate-y-1.5 transition-all duration-500 group flex flex-col h-full relative overflow-hidden">
                <div className="absolute -top-8 -right-8 w-24 h-24 bg-cyan-500/5 dark:bg-cyan-500/10 rounded-full blur-xl group-hover:bg-cyan-500/20 transition-colors duration-500 pointer-events-none" aria-hidden="true"></div>
                <div className="mb-4 relative z-10">
                  <FolderGit2 size={28} className="text-slate-300 dark:text-slate-700 mb-3 group-hover:text-cyan-500 transition-colors duration-300" strokeWidth={1.5} aria-hidden="true" />
                  <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white mb-3">{project.title}</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {DATA.certifications.map((cert, idx) => (
            <FadeIn key={idx} delay={(idx % 3) * 80}>
              <div className="flex flex-col bg-white/60 dark:bg-slate-900/40 backdrop-blur-md p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md hover:-translate-y-1 hover:border-cyan-400/50 dark:hover:border-cyan-600/50 transition-all duration-300 group h-full">
                <div className="flex items-start justify-between gap-3 mb-3">
                  ...
                  <Shield size={18} className="shrink-0 text-slate-300 dark:text-slate-700 group-hover:text-cyan-500 transition-colors" aria-hidden="true" />
                </div>
      ...
      <Section id="awards" title="Honors & Awards" icon={Award}>
        <div className="grid sm:grid-cols-2 gap-5">
          {DATA.awards.map((award, idx) => (
            <FadeIn key={idx} delay={idx * 100}>
              <div className="bg-gradient-to-br from-white to-slate-50 dark:from-slate-900/80 dark:to-slate-900/40 backdrop-blur-md p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-lg transition-all duration-300 group flex gap-4 h-full">
                ...
                <div className="min-w-0">
                  ...
                  <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white mb-1 group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors leading-snug">
                    {award.title}
                  </h3>
                  <p className="text-xs font-bold text-amber-600 dark:text-amber-500 mb-2.5">{award.issuer}</p>
                  <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm">{award.description}</p>
                </div>
              </div>
            </FadeIn>
          ))}
      ...
      <Section id="extracurricular" title="Leadership & Extracurricular" icon={Users}>
        <div className="grid sm:grid-cols-2 gap-5">
          {DATA.extracurricular.map((item, idx) => (
            <FadeIn key={idx} delay={idx * 100}>
              <div className="bg-white/60 dark:bg-slate-900/40 backdrop-blur-md p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-lg transition-all duration-300 group h-full">
                ...
                <p className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-3 pb-3 border-b border-slate-100 dark:border-slate-800">{item.organization}</p>
      ...
      <footer className="bg-white dark:bg-[#030712] text-slate-500 dark:text-slate-400 py-10 md:py-12 border-t border-slate-200 dark:border-slate-900 relative z-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          <div className="inline-flex items-center justify-center p-2.5 bg-cyan-100 dark:bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 rounded-xl mb-5 shadow-[0_0_15px_rgba(34,211,238,0.15)]" aria-hidden="true">
            <Shield size={26} strokeWidth={1.5} />
          </div>
          <h2 className="text-xl sm:text-2xl font-extrabold text-slate-900 dark:text-white mb-6 tracking-tight">
            Let's build something secure.
          </h2>
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            <a
              href={`mailto:${DATA.personal.email}`}
              className="flex items-center gap-1.5 px-5 py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-900 dark:hover:bg-slate-800 rounded-full text-slate-700 dark:text-slate-300 text-sm font-bold transition-all shadow-sm"
            >
            ...
            <a
              ...
              className="flex items-center gap-1.5 px-5 py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-900 dark:hover:bg-slate-800 rounded-full text-slate-700 dark:text-slate-300 text-sm font-bold transition-all shadow-sm"
            >
              <Linkedin size={16} className="text-[#0a66c2] dark:text-[#70b5f9]" aria-hidden="true" /> Connect
            </a>
            <a
              href={DATA.personal.scholar}
              target="_blank"
              ...
              className="flex items-center gap-1.5 px-5 py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-900 dark:hover:bg-slate-800 rounded-full text-slate-700 dark:text-slate-300 text-sm font-bold transition-all shadow-sm"
            >
              <GraduationCap size={16} aria-hidden="true" /> Google Scholar
            </a>
          </div>
          <div className="pt-6 border-t border-slate-100 dark:border-slate-800/50 text-xs font-medium">
